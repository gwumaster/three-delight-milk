          ...
          <div className="flex items-center justify-around h-full px-10 relative">
            ...
            <div className="bottle-stage stage-item text-center opacity-0 relative z-10">
              <div className="relative mb-6 group">
                <FaGlassWhiskey className="w-32 h-32 mx-auto text-foreground transition-transform group-hover:rotate-12" />
                <div className="absolute inset-0 animate-ping opacity-75">
                  <FaGlassWhiskey className="w-32 h-32 mx-auto text-foreground/50" />
                </div>
              </div>
            ...
            <div className="packing-stage stage-item text-center opacity-0 relative z-10">
              <div className="relative mb-6 group">
                <FaBox className="w-32 h-32 mx-auto text-foreground transition-transform group-hover:scale-110" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Hygienic Packing</h3>
              <p className="text-foreground/70">Sealed with care</p>
            </div>

            {/* Stage 3: Truck/Delivery */}
            <div className="truck-stage stage-item text-center opacity-0 relative z-10">
              <div className="relative mb-6 group">
                <TbBikeFilled className="w-32 h-32 mx-auto text-foreground transition-transform group-hover:translate-x-4" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Doorstep Delivery</h3>
              <p className="text-foreground/70">Free first week trial</p>
            </div>

            {/* Stage 4: Cow/Farm */}
            <div className="cow-stage stage-item text-center opacity-0 relative z-10">
              <div className="relative mb-6 group">
                <GiCow className="w-32 h-32 mx-auto text-foreground transition-transform group-hover:rotate-6" />
              </div>
              <h3 className="text-2xl font-bold mb-2">Farm Fresh Source</h3>
              <p className="text-foreground/70">Pure from happy cows</p>
            </div>
          </div>
        </section>
